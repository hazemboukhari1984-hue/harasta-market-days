...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, g as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, h as RequestStatusResponseStatus, U as UnknownError, i as RequestStatusDoneNoReplyErrorCode, k as RejectError, m as CertifiedRejectErrorCode, n as UNREACHABLE_ERROR, I as InputError, p as InvalidReadStateRequestErrorCode, q as ReadRequestType, s as Principal, t as IDL, w as MissingCanisterIdErrorCode, H as HttpAgent, x as encode, Q as QueryResponseStatus, y as UncertifiedRejectErrorCode, z as isV3ResponseBody, A as isV2ResponseBody, D as UncertifiedRejectUpdateErrorCode, F as UnexpectedErrorCode, G as decode, J as Subscribable, K as pendingThenable, N as resolveEnabled, O as shallowEqualObjects, V as resolveStaleTime, W as noop, X as environmentManager, Y as isValidTimeout, Z as timeUntilStale, _ as timeoutManager, $ as focusManager, a0 as fetchState, a1 as replaceData, a2 as notifyManager, a3 as hashKey, a4 as getDefaultState, r as reactExports, a5 as shouldThrowError, a6 as useQueryClient, f as useInternetIdentity, a7 as createActorWithConfig, a8 as Variant, a9 as Record, aa as Service, ab as Func, ac as Vec, ad as Text, ae as Opt, af as Null, ag as Nat, ah as Int, u as useLanguage, j as jsxRuntimeExports, B as Button, d as cn } from "./index-DhcdhH4l.js";
...
const DurationPackage$1 = Variant({
  "fourHours": Null,
  "oneHour": Null,
  "twoHours": Null,
  "fullDay": Null,
...
Service({
  "getAllBookings": Func([], [Vec(Booking)], []),
  "getBooking": Func([BookingRef], [Opt(Booking)], ["query"]),
  "getBookingCount": Func([], [Nat], ["query"]),
  "getBookingsByDate": Func([Text], [Vec(Booking)], ["query"]),
  "submitBooking": Func([BookingRequest], [BookingRef], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const BookingRef2 = IDL2.Text;
  const DurationPackage2 = IDL2.Variant({
    "fourHours": IDL2.Null,
    "oneHour": IDL2.Null,
    "twoHours": IDL2.Null,
    "fullDay": IDL2.Null,
    "threeHours": IDL2.Null,
    "weekly": IDL2.Null
  });
  const PaymentMethod2 = IDL2.Variant({
    "cash": IDL2.Null,
    "electronic": IDL2.Null
  });
  const Timestamp2 = IDL2.Int;
  const StoreType2 = IDL2.Variant({ "large": IDL2.Null, "small": IDL2.Null });
  const Booking2 = IDL2.Record({
    "id": IDL2.Nat,
    "ref": BookingRef2,
    "merchantName": IDL2.Text,
    "duration": DurationPackage2,
    "paymentMethod": PaymentMethod2,
    "rentalPrice": IDL2.Nat,
    "createdAt": Timestamp2,
    "deposit": IDL2.Nat,
    "nationalId": IDL2.Text,
    "bookingDate": IDL2.Text,
  ...
  return IDL2.Service({
    "getAllBookings": IDL2.Func([], [IDL2.Vec(Booking2)], []),
    "getBooking": IDL2.Func([BookingRef2], [IDL2.Opt(Booking2)], ["query"]),
    "getBookingCount": IDL2.Func([], [IDL2.Nat], ["query"]),
    "getBookingsByDate": IDL2.Func([IDL2.Text], [IDL2.Vec(Booking2)], ["query"]),
    "submitBooking": IDL2.Func([BookingRequest2], [BookingRef2], [])
  });
};
var DurationPackage = /* @__PURE__ */ ((DurationPackage2) => {
  DurationPackage2["fourHours"] = "fourHours";
  DurationPackage2["oneHour"] = "oneHour";
  DurationPackage2["twoHours"] = "twoHours";
  DurationPackage2["fullDay"] = "fullDay";
  DurationPackage2["threeHours"] = "threeHours";
  DurationPackage2["weekly"] = "weekly";
  return DurationPackage2;
})(DurationPackage || {});
var PaymentMethod = /* @__PURE__ */ ((PaymentMethod2) => {
  PaymentMethod2["cash"] = "cash";
  PaymentMethod2["electronic"] = "electronic";
  return PaymentMethod2;
})(PaymentMethod || {});
var StoreType = /* @__PURE__ */ ((StoreType2) => {
  StoreType2["large"] = "large";
  StoreType2["small"] = "small";
  return StoreType2;
})(StoreType || {});
class Backend {
...
function from_candid_DurationPackage_n4(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n5(_uploadFile, _downloadFile, value);
}
function from_candid_PaymentMethod_n6(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n7(_uploadFile, _downloadFile, value);
}
function from_candid_StoreType_n8(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n5(_uploadFile, _downloadFile, value) {
  return "fourHours" in value ? "fourHours" : "oneHour" in value ? "oneHour" : "twoHours" in value ? "twoHours" : "fullDay" in value ? "fullDay" : "threeHours" in value ? "threeHours" : "weekly" in value ? "weekly" : value;
}
function from_candid_variant_n7(_uploadFile, _downloadFile, value) {
  return "cash" in value ? "cash" : "electronic" in value ? "electronic" : value;
}
function from_candid_variant_n9(_uploadFile, _downloadFile, value) {
  return "large" in value ? "large" : "small" in value ? "small" : value;
}
...
function to_candid_BookingRequest_n11(_uploadFile, _downloadFile, value) {
  return to_candid_record_n12(_uploadFile, _downloadFile, value);
}
function to_candid_DurationPackage_n13(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n14(_uploadFile, _downloadFile, value);
}
function to_candid_PaymentMethod_n15(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n16(_uploadFile, _downloadFile, value);
}
function to_candid_StoreType_n17(_uploadFile, _downloadFile, value) {
...
function QrCodeDisplay({
  ...
  reactExports.useEffect(() => {
    ...
    browser.toCanvas(canvasRef.current, value, {
      ...
      var _a2;
      setDataUrl(((_a2 = canvasRef.current) == null ? void 0 : _a2.toDataURL("image/png")) ?? null);
    }).catch(() => {
    });
  }, [value, size]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        label && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center", children: label }),
        showButtons && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 flex-wrap justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
...
function useGetBookingsByDate(date) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
export {
  DurationPackage as D,
  Input as I,
  PaymentMethod as P,
  QrCodeDisplay as Q,
  StoreType as S,
  useGetAllBookings as a,
  useGetBookingsByDate as b,
  useGetBookingCount as c,
  useSubmitBooking as u
};
