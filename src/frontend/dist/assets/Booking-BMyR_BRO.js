import { r as reactExports, j as jsxRuntimeExports, R as React, a as useComposedRefs, b as composeRefs, d as cn, e as createSlot$1, o, v as vt, u as useLanguage, B as Button } from "./index-DhcdhH4l.js";
import { u as useSubmitBooking, S as StoreType, D as DurationPackage, P as PaymentMethod, Q as QrCodeDisplay, I as Input } from "./useQueries-DrAdgREb.js";
...
const SMALL_PRICES = {
  [DurationPackage.oneHour]: 3e4,
  [DurationPackage.twoHours]: 5e4,
  [DurationPackage.threeHours]: 6e4,
  [DurationPackage.fourHours]: 7e4,
  [DurationPackage.fullDay]: 85e3,
  [DurationPackage.weekly]: 5e5
};
const LARGE_PRICES = {
  [DurationPackage.oneHour]: 5e4,
  [DurationPackage.twoHours]: 9e4,
  [DurationPackage.threeHours]: 12e4,
  [DurationPackage.fourHours]: 14e4,
  [DurationPackage.fullDay]: 15e4,
  [DurationPackage.weekly]: 9e5
};
const DEPOSIT = 1e5;
function Booking() {
  const { t, isRTL } = useLanguage();
  const { mutateAsync, isPending } = useSubmitBooking();
  const [merchantName, setMerchantName] = reactExports.useState("");
  const [nationalId, setNationalId] = reactExports.useState("");
  const [bookingDate, setBookingDate] = reactExports.useState("");
  const [storeType, setStoreType] = reactExports.useState(StoreType.small);
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setSuccessRef(ref);
      ue.success(t("bookingSuccess"));
    } catch {
      ue.error(t("error"));
    }
  }
  if (successRef) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center px-4 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-card border border-primary/40 rounded-2xl p-8 max-w-md w-full text-center space-y-6",
        "data-ocid": "booking.success_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-primary/20 mx-auto flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: "✓" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: t("bookingSuccess") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background rounded-xl p-5 border border-border/40 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: t("qrTitle") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              QrCodeDisplay,
              {
                value: successRef,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-base font-bold text-primary", children: successRef })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/40 pt-4 space-y-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: t("rentalPrice") }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: t("deposit") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between border-t border-border/40 pt-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground", children: t("totalPrice") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: isRTL ? "حجز آخر" : "New Booking"
            }
          )
        ]
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-foreground", children: t("bookingTitle") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-3", children: t("bookingSubtitle") })
        ]
      }
    ),
      ...
      "form",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            errors.merchantName && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-destructive text-xs",
                "data-ocid": "booking.merchant_name_field_error",
                children: errors.merchantName
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "nationalId", className: "text-foreground font-medium", children: t("fieldNationalId") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "nationalId",
            ...
            errors.nationalId && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-destructive text-xs",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            errors.bookingDate && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-destructive text-xs",
                "data-ocid": "booking.date_field_error",
                children: errors.bookingDate
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-foreground font-medium", children: t("fieldStoreType") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: [
              ...
              "button",
              {
                ...
                className: `py-3 px-4 rounded-xl border text-sm font-medium transition-smooth ${storeType === opt.value ? "border-primary bg-primary/15 text-primary" : "border-border/60 text-muted-foreground hover:border-primary/40"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-foreground font-medium", children: t("fieldDuration") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: DURATION_OPTIONS.map((opt) => {
              var _a;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `py-2.5 px-3 rounded-lg border text-sm font-medium transition-smooth text-start ${duration === opt.value ? "border-primary bg-primary/15 text-primary" : "border-border/60 text-muted-foreground hover:border-primary/40"}`,
                  "data-ocid": `booking.duration_${opt.value}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: t(opt.labelKey) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold", children: [
                      (_a = priceMap[opt.value]) == null ? void 0 : _a.toLocaleString(),
                      " ",
                      t("currency")
                    ] })
                  ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-foreground font-medium", children: t("fieldPaymentMethod") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: [
              ...
              "button",
              {
                ...
                className: `py-3 px-4 rounded-xl border text-sm font-medium transition-smooth ${paymentMethod === opt.value ? "border-primary bg-primary/15 text-primary" : "border-border/60 text-muted-foreground hover:border-primary/40"}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Label,
                    {
                      ...
                      children: isRTL ? "أوافق على الشروط والأحكام وأُقر بدفع التأمين المسترد 100,000 ل.س" : "I agree to the Terms & Conditions and acknowledge the refundable deposit of 100,000 SYP"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: isRTL ? "يُعاد التأمين فور تسليم المحل سليماً ونظيفاً" : "Deposit is refunded upon clean handover of the store" })
                ] })
              ]
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: isPending ? t("loading") : t("submitBooking")
            }
          )
        ]
      }
